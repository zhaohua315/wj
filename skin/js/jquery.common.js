...
function search(){if($("#baidusearch").val()==""||$("#baidusearch").val()==0||$("#baidusearch").val()=="在这里搜索您感兴趣的读后感"){ShowAlert("请输入搜索关键词");$("#baidusearch").focus();return false}var keywords=document.getElementById("baidusearch").value;self.location.href="/search.php?searchword="+keywords+""};
